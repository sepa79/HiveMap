...
- **POC discipline.**
  - This is a throwaway proof of concept, not HiveMap 1.0.
  - Validate the workflow before hardening architecture.
  - Record learnings before replacing or deleting the POC.

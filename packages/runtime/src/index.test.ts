  ...
  return {
    ...
    files: [
      ...
      },
      {
        workspaceId,
        indexId,
        path: "docs/adr/0001-agent-interface.md",
        language: "markdown",
        sourceKind: "documentation",
        contentHash: "noise-agent-interface-adr",
        byteSize: 96,
      },
      {
        workspaceId,
        indexId,
        path: "docs/specs/mcp-tools.md",
        language: "markdown",
        sourceKind: "documentation",
        contentHash: "noise-mcp-tools-spec",
        byteSize: 128,
      },
      {
        workspaceId,
        indexId,
        path: "docs/specs/capture-policy.md",
        language: "markdown",
        sourceKind: "documentation",
        contentHash: "noise-capture-policy-spec",
        byteSize: 112,
      },
      {
        workspaceId,
  ...
  return {
    ...
    chunks: [
      ...
      },
      {
        workspaceId,
        indexId,
        id: "noise-agent-interface-adr",
        filePath: "docs/adr/0001-agent-interface.md",
        language: "markdown",
        sourceKind: "documentation",
        startLine: 1,
        endLine: 2,
      ...
      },
      {
        workspaceId,
        indexId,
        id: "noise-mcp-tools-spec",
        filePath: "docs/specs/mcp-tools.md",
        language: "markdown",
        sourceKind: "documentation",
        startLine: 1,
        endLine: 2,
        text: "# MCP Tools\nDraft MCP surface for agents. MCP is the primary agent interface.",
        contentHash: "noise-mcp-tools-spec",
      },
      {
        workspaceId,
        indexId,
        id: "noise-capture-policy-spec",
        filePath: "docs/specs/capture-policy.md",
        language: "markdown",
        sourceKind: "documentation",
        startLine: 1,
        endLine: 2,

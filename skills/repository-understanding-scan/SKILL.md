...
6. Create findings only after repository shape is coherent enough that the evidence is about the repository, not about scan misconfiguration.
...
- findings only after the scan is findings-ready;
